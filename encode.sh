...
#
# Change log:
# 2012-01-12: Initial forked release. 	- Updated to run on Linux (Debian/ *ubuntu)
# 					- Updated find to work with linux
#					- Updated script to run with Normal preset (good for reducing file size)
###############################################################################
...
convert() {
	...
	echo "" | $hbcli -i "$1" -o "$2" --preset="Normal";
}
